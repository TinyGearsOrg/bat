...
import org.tinygears.bat.util.getExternalClassSignature
import org.tinygears.bat.util.getExternalFieldSignature
...
//    fun methodSignatures(signature: String, expectedOutput: String) {

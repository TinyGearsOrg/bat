...
import org.tinygears.bat.dexfile.io.DexFileReader
import org.tinygears.bat.dexfile.visitor.multiClassDefVisitorOf
import org.tinygears.bat.io.*
import org.tinygears.bat.smali.SmaliDisassembler
            ...
            entry.getInputStream().use { `is` ->
                ...
                dexFile.parallelClassDefsAccept(Dispatchers.IO) {
                    multiClassDefVisitorOf(
                        ...
                        SmaliDisassembler(FileOutputStreamFactory(outputPath, "smali"))
                    )
                }

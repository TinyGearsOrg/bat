...
import org.tinygears.bat.dexfile.DexFormat
import org.tinygears.bat.dexfile.io.DexFileWriter
import org.tinygears.bat.io.DataEntry
import org.tinygears.bat.io.PathInputSource
import org.tinygears.bat.io.filterDataEntriesBy
import org.tinygears.bat.smali.SmaliAssembleException
import org.tinygears.bat.smali.SmaliAssembler
...
class SmaliCommand : Runnable {
    ...
    override fun run() {
        ...
        val assembler = SmaliAssembler(dexFile, lenientMode, warningPrinter)

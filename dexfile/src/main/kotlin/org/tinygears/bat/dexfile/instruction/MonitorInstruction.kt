...
class MonitorInstruction: SimpleInstruction {
    ...
    override fun accept(dexFile: DexFile, classDef: ClassDef, method: EncodedMethod, code: Code, offset: Int, visitor: InstructionVisitor) {
        visitor.visitMonitorInstruction(dexFile, classDef, method, code, offset, this)
    }

    companion object {
        fun of(opcode: DexOpCode, rA: Int): MonitorInstruction {
            return MonitorInstruction(opcode, rA)
        }

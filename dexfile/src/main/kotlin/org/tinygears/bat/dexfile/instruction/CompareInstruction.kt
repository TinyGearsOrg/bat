...
class CompareInstruction: SimpleInstruction {

    private constructor(opCode: DexOpCode): super(opCode)

    private constructor(opCode: DexOpCode, rA: Int, rB: Int, rC: Int): super(opCode, rA, rB, rC)

    override fun accept(dexFile: DexFile, classDef: ClassDef, method: EncodedMethod, code: Code, offset: Int, visitor: InstructionVisitor) {
        visitor.visitCompareInstruction(dexFile, classDef, method, code, offset, this)
    }

    companion object {
        fun of(opcode: DexOpCode, rA: Int, rB: Int, rC: Int): CompareInstruction {
            return CompareInstruction(opcode, rA, rB, rC)
        }

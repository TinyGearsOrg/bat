...
package org.tinygears.bat.dexdump

import org.tinygears.bat.dexfile.*
import org.tinygears.bat.dexfile.annotation.*
...
import org.tinygears.bat.dexfile.visitor.*
...
import org.tinygears.bat.util.toPrintableAsciiString
...
internal class ClassDefPrinter constructor(private val printer: Mutf8Printer, private val disassembleCode: Boolean) :
    ...
    override fun visitParameterAnnotationSetRefList(dexFile: DexFile, classDef: ClassDef, parameterAnnotation: ParameterAnnotation, annotationSetRefList: AnnotationSetRefList) {
        ...
        for (i in 0 until annotationSetRefList.size) {
            printer.println("#$i")
            val annotationSetRef = annotationSetRefList[i]
            annotationSetRef.accept(dexFile, this)
            if (annotationSetRef.annotationSet.isEmpty) {

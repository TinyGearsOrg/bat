...
import org.tinygears.bat.classfile.attribute.preverification.ObjectVariable
...
class TypedReferenceValue constructor(override val type: JvmType, override val isNull: Boolean = false): ReferenceValue {

    override fun toVerificationType(constantPoolEditor: ConstantPoolEditor): VerificationType {
        return ObjectVariable.of(constantPoolEditor.addOrGetClassConstantIndex(type.toJvmClassName().toString()))
    }

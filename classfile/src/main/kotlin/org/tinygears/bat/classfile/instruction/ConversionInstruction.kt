...
class ConversionInstruction private constructor(opCode: JvmOpCode): SimpleInstruction(opCode) {

    override fun accept(classFile: ClassFile, method: Method, code: CodeAttribute, offset: Int, visitor: InstructionVisitor) {
        visitor.visitConversionInstruction(classFile, method, code, offset, this)
    }

...
import org.tinygears.bat.classfile.attribute.preverification.NullVariable
...
import org.tinygears.bat.util.JAVA_LANG_OBJECT_TYPE
import org.tinygears.bat.util.JvmType

object NullReferenceValue: ReferenceValue {
    override val type: JvmType
        get() = JAVA_LANG_OBJECT_TYPE

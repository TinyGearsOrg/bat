...
class CompareInstruction private constructor(opCode: JvmOpCode): SimpleInstruction(opCode) {

    override fun accept(classFile: ClassFile, method: Method, code: CodeAttribute, offset: Int, visitor: InstructionVisitor) {
        visitor.visitCompareInstruction(classFile, method, code, offset, this)
    }

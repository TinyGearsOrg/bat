...
package org.tinygears.bat.jasm
...
import org.tinygears.bat.jasm.disassemble.JasmPrinter

class JasmDisassembler(private val outputStreamFactory: OutputStreamFactory) : ClassFileVisitor {

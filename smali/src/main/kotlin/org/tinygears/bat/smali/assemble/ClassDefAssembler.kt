...
import org.tinygears.bat.dexfile.editor.ClassDefEditor
import org.tinygears.bat.dexfile.editor.DexEditor
import org.tinygears.bat.dexfile.editor.FieldEditor
import org.tinygears.bat.dexfile.editor.MethodEditor
import org.tinygears.bat.smali.parser.SmaliBaseVisitor
...
internal class ClassDefAssembler(private val dexEditor:      DexEditor,
    ...
    override fun visitSField(ctx: SFieldContext): List<ClassDef> {
        ...
        try {
            val fieldIDIndex = dexEditor.addOrGetFieldIDIndex(classDefEditor.classTypeString, name, type)
    ...
    override fun visitSMethod(ctx: SMethodContext): List<ClassDef> {
        ...
        try {
            val methodIDIndex = dexEditor.addOrGetMethodIDIndex(classDefEditor.classTypeString, name, parameterTypes, returnType)
